...
class PlayerService {
  ...
  Future<PlayerData> addLiability(PlayerData playerData, Liability liability) async {
  ...
  Future<PlayerData> updateAsset(PlayerData playerData, int index, Asset updatedAsset) async {
  ...
  Future<PlayerData> updateLiability(PlayerData playerData, int index, Liability updatedLiability) async {
  ...
  Future<PlayerData> sellAsset(PlayerData playerData, int index, int sellPrice) async {
